            ...
            <div class="modal-body">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" name="tipoLavorazione" class="form-input"
                               placeholder="Es: Spremitura, Cottura..." required>
                    </div>

                    <div class="form-group">
                        <label class="form-label required">Data</label>
                        <input type="date" name="dataLavorazione" class="form-input"
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="number" name="quantitaIngresso" class="form-input"
                               step="0.01" min="0" required>
                    </div>

                    <div class="form-group">
                        <label class="form-label required">Quantità Ottenuta (kg)</label>
                        <input type="number" name="quantitaOttenuta" class="form-input"
                               step="0.01" min="0" required>
                    </div>
                </div>
            </div>
