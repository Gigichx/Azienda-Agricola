...
$categorie = fetchAll($pdo, "SELECT c.*, COUNT(p.idProdotto) as totaleProdotti
                              FROM CATEGORIA c
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <div class="table-actions">
                            <button class="action-btn btn-edit" onclick='editCategoria(<?php echo json_encode($c); ?>)'>✏️</button>
